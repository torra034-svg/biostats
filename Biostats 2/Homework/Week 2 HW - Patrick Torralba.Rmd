---
title: "Week 2 HW - Patrick Torralba"
...
#RQ1) What is the effect of weight change on total cholesterol change without adjusting for anything?
```{r data cleaning}
RQ1 <- tomhs %>% 
...
#RQ2) What is the effect of weight change on total cholesterol change after adjusting for sex?
...
#RQ3) Given these results, is there evidence that sex may be a confounding variable in this case?
No, there is not any evidence that sex may be a confounding variable.
