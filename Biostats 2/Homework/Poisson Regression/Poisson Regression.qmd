...
## Model Evaluation for Overdispersion Test {#sec-evaluation}
...
## Quasi-Poisson Regression Model for Overdispersed Data {#sec-Quasi-Poisson-reg-model}
...
-   Generating tables
    ...
    -   Use the tbl_regression() function from the gtsummary() package to generate really good looking tables in the html render
        ...
        -   See @sec-Quasi-Poisson-reg-model as an example
